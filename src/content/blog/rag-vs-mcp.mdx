...
Alternatively, you could use a local model with Ollama. [This article](https://medium.com/data-science-in-your-pocket/model-context-protocol-mcp-using-ollama-e719b2d9fd7a) provides a detailed step-by-step guide on how to connect Ollama with an MCP server.
...
* [Medium: Model Context Protocol (MCP) using Ollama](https://medium.com/data-science-in-your-pocket/model-context-protocol-mcp-using-ollama-e719b2d9fd7a)